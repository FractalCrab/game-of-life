...
func seedDefaultGlider() {
	...
	// Same shape as your /pattern/glider handler :contentReference[oaicite:2]{index=2}
...
func handleClear(w http.ResponseWriter, r *http.Request) {
	...
	renderGrid(w)
	fmt.Fprint(w, `<div id="auto-play-container" hx-swap-oob="outerHTML"></div>`)
}
...
func renderGrid(w http.ResponseWriter) {
	w.Header().Set("X-Generation", strconv.Itoa(gameInstance.GetGeneration()))
